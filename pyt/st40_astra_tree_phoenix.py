...
#    t.setDefault(astra)
    ...
    n = mh.createNode(t,"RP","SIGNAL","R filament position, M");    
    n = mh.createNode(t,"ZP","SIGNAL","Z filament position, M");    
    n = mh.createNode(t,"RESP","SIGNAL","filament resistance, Ohm");    
    ...
    n = mh.createNode(t,"MVALUE","SIGNAL","experimental");    
    n = mh.createNode(t,"WEIGHT","SIGNAL","");    
#DIVPSRB,DIVPSRT,HFSPSRB,HFSPSRT,MCB,MCT,GASBFLB,GASBFLT,BVLB,BVLT,DIVB,DIVB,INIVC000
...
#     Energy=0.5*int(PBLON*dV)+int(PBPER*dV)
    ...
    n = mh.createNode(t,"RXP1","SIGNAL","r-position,m");    
    n = mh.createNode(t,"ZXP1","SIGNAL","z-position,m");    
    n = mh.createNode(t,"RXP2","SIGNAL","r-position,m");    
    n = mh.createNode(t,"ZXP2","SIGNAL","z-position,m");    
