# python3 pyt/panel_plot_glob2.py
...
combobox5=sg.InputCombo(values=names, **combo_style, enable_events=True, key='-COMBO5-')
layout = [[sg.T("")],
          ...
          [sg.T("ASTRA shot="), sg.Input('13011228', size=(8,1),key="-shotastra-"),
           sg.Button('reread shot',size=(10,1))],
          [sg.T("RUN"),combobox3,sg.Button('reread run',size=(10,1)),
           sg.Button('HELPrun',size=(10,1))],
          [sg.T("Globals"),combobox4,sg.Button('HELPglob',size=(10,1))],
          [sg.T("Calc globals"),combobox5],
